...
from photon.core.colors import good, info, run, green, red, white, end, bad
...
import photon.core.config
from photon.core.config import INTELS
from photon.core.flash import flash
from photon.core.mirror import mirror
from photon.core.prompt import prompt
from photon.core.requester import requester
from photon.core.updater import updater
from photon.core.utils import (luhn,
                        proxy_type,
                        is_good_proxy,
                        top_level,
                        extract_headers,
                        ...
                        timer,
                        writer)
from photon.core.regex import rintels, rendpoint, rhref, rscript, rentropy

from photon.core.zap import zap
...
if args.dns:
    ...
    from photon.plugins.find_subdomains import find_subdomains
    ...
    from photon.plugins.dnsdumpster import dnsdumpster
    print('%s Generating DNS map' % run)
    dnsdumpster(domain, output_dir)

if args.export:
    from photon.plugins.exporter import exporter
